...
const Home = () => {
  ...
  const books = [
    ...
    },
    {
      ...
      price: 12.99,
      details: 'يعد هذا الكتاب رفيقًا مثاليًا لتعليم الأطفال فوائد الصيام وأهمية شهر رمضان المبارك بطريقة ممتعة وتفاعلية. يعيش الطفل تجربة رمضان مع الشخصيات الرائعة أحمد وزهراء من خلال الصور الجميلة والأنشطة المسلية.  صف لكتاب أول 100 كلمة',
