...
//         "https://ecommercebackend-jzct.onrender.com/book/Active"
//       );
...
//   const handleBookPress = (item) => {
//     const { _id, title, price, details, image } = item;
//     const imageUrl = image && image.secure_url ? image.secure_url : null;
...
const Home = () => {
  ...
  const books = [
    ...
    },
    {
      ...
      price: 120,
      details:
        " هو كتاب للأطفال يهدف إلى تعليم الأطفال الصغار أولى الكلمات بطريقة ممتعة وتشويقية. يحتوي الكتاب على مجموعة من الصور الملونة والجذابة التي تمثل مفاهيم وكلمات يومية شائعة في حياة الأطفال، وغيرها من المواضيع الأساسية التي يمكن أن تكون مفيدة لتوسيع مفردات الطفل وتطويرها .",
